...
ALTER TABLE PUBLIC.PULLREQUEST ADD COLUMN IF NOT EXISTS NUMBEROFREVIEWCOMMENTS INTEGER DEFAULT 0;

ALTER TABLE PUBLIC.PULLREQUEST DROP COLUMN IF EXISTS NUMBEROFCOMMENTS;
