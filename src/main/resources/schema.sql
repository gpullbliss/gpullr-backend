...
CREATE CACHED TABLE IF NOT EXISTS PUBLIC.RANKINGS (
    ...
    SUMOFSCORES DOUBLE DEFAULT 0 NOT NULL,
...
-- DROP TABLE IF EXISTS PUBLIC.RANKINGLIST_RANKING;
...
ALTER TABLE PUBLIC.USERSETTINGS ADD COLUMN IF NOT EXISTS LANGUAGE VARCHAR(2);
...
-- ALTER TABLE PUBLIC.RANKINGS ADD CONSTRAINT IF NOT EXISTS PUBLIC.FK_RANKING_LIST_ID FOREIGN KEY(RANKING_LIST_ID) REFERENCES PUBLIC.RANKINGLIST(ID) NOCHECK; 
