...
ALTER TABLE PUBLIC.COMMENTS ADD CONSTRAINT IF NOT EXISTS PUBLIC.CONSTRAINT_CMT PRIMARY KEY(SHA);
ALTER TABLE PUBLIC.COMMENTS ADD CONSTRAINT IF NOT EXISTS PUBLIC.FK_CMITS_PR FOREIGN KEY(PULLREQUEST_ID) REFERENCES PUBLIC.PULLREQUEST(ID) NOCHECK;
