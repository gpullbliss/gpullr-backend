...
CREATE CACHED TABLE IF NOT EXISTS PUBLIC.RANKINGLIST_RANKINGS(
    ...
    NUMBEROFMERGEDPULLREQUESTS BIGINT,
    RANK INTEGER
);    
CREATE CACHED TABLE IF NOT EXISTS PUBLIC.USERSTATISTICS(
    ID BIGINT DEFAULT (NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_A5458BDB_906E_4DD7_91FA_53B11E88BEA2) NOT NULL NULL_TO_DEFAULT SEQUENCE PUBLIC.SYSTEM_SEQUENCE_A5458BDB_906E_4DD7_91FA_53B11E88BEA2,
    USER_ID INTEGER NOT NULL
);
ALTER TABLE PUBLIC.USERSTATISTICS ADD CONSTRAINT IF NOT EXISTS PUBLIC.CONSTRAINT_2E PRIMARY KEY(ID);

CREATE CACHED TABLE IF NOT EXISTS PUBLIC.USERSTATISTICS_CLOSEDPULLREQUESTS(
    USERSTATISTICS_ID BIGINT NOT NULL,
    CLOSEDATE VARCHAR(255) NOT NULL,
    PULLREQUESTURL VARCHAR(255)
);
...
ALTER TABLE PUBLIC.USERSTATISTICS ADD CONSTRAINT IF NOT EXISTS PUBLIC.UK_SVY5IK0G4QLD25NVOH4RY56Q7 UNIQUE(USER_ID);
...
ALTER TABLE PUBLIC.USERSTATISTICS ADD CONSTRAINT IF NOT EXISTS PUBLIC.FK_SVY5IK0G4QLD25NVOH4RY56Q7 FOREIGN KEY(USER_ID) REFERENCES PUBLIC.USER(ID) NOCHECK;

ALTER TABLE PUBLIC.USERSTATISTICS_CLOSEDPULLREQUESTS ADD CONSTRAINT IF NOT EXISTS PUBLIC.FK_41NKQDFVT8P0DNBAAK9EY7RQ4 FOREIGN KEY(USERSTATISTICS_ID) REFERENCES PUBLIC.USERSTATISTICS(ID) NOCHECK;