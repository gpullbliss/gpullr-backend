...
CREATE CACHED TABLE IF NOT EXISTS PUBLIC.COMMITS(
    SHA VARCHAR(150) NOT NULL,
    COMMITDATE VARCHAR(255),
    PULLREQUEST_ID INTEGER NOT NULL
);
ALTER TABLE PUBLIC.COMMITS ADD CONSTRAINT IF NOT EXISTS PUBLIC.CONSTRAINT_CMT PRIMARY KEY(SHA);
ALTER TABLE PUBLIC.COMMITS ADD CONSTRAINT IF NOT EXISTS PUBLIC.FK_CMITS_PR FOREIGN KEY(PULLREQUEST_ID) REFERENCES PUBLIC.PULLREQUEST(ID) NOCHECK;
